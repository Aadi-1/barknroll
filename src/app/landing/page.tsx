...
export default function LandingCustom() {
  ...
  return (
    <main className="scroll-smooth relative overflow-x-hidden min-h-screen bg-gradient-to-br from-[#f5f0e8] to-[#e8ddd0] font-serif">
      ...
      <section
        id="deals"
        className="bg-white rounded-3xl pb-10 pt-6 p-2 border-4 border-[#4a7c59] shadow-xl mb-5 mt-10"
      >
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-8">
          ...
          <div className="w-72 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 text-center border-2 border-[#4a7c59] relative overflow-hidden">
            ...
            <div className="flex items-baseline justify-center space-x-2 mb-1">
              <span className="text-4xl text-[#2d4a35] font-bold">$69</span>
            ...
            <p className="text-gray-600 text-sm leading-snug">
              <strong className="text-2xl">3 Walks</strong>
              <br />
          ...
          <div className="w-72 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 text-center border-2 border-[#4a7c59] relative overflow-hidden">
            ...
            <div className="flex items-baseline justify-center space-x-2 mb-1">
              <span className="text-4xl text-[#2d4a35] font-bold">$110</span>
              <span className="text-xl text-red-800 line-through opacity-60">
                $125
              </span>
            </div>
            ...
            <p className="text-gray-600 text-sm leading-snug">
              <strong className="text-2xl">5 Walks</strong>
              <br />
              Most popular choice!
            </p>
          </div>
          ...
          <div className="w-72 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 text-center border-2 border-[#4a7c59] relative overflow-hidden">
            ...
            <div className="flex items-baseline justify-center space-x-2 mb-1">
              <span className="text-4xl text-[#2d4a35] font-bold">$200</span>
              <span className="text-xl text-red-800 line-through opacity-60">
                $250
              </span>
            </div>
            ...
            <p className="text-gray-600 text-sm leading-snug">
              <strong className="text-2xl">10 Walks</strong>
              <br />
              Maximum savings!
            </p>
          </div>
